...
def run_assistant():
    ...
    # stop assistant
        ...
        speak("I am here to assist you, ask something like open youtube, open notepad and time")

# main function
if __name__ == "__main__":
    speak("Hey hi, Samaira, I am here to assist you, ask something like open youtube, open notepad and time")     
    while True:
        run_assistant()
